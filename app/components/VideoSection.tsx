...
export default function VideoSection() {
  return (
    <section id="videos" className="portfolio section">
      {/* Section Title */}
      <div className="container section-title" data-aos="fade-up">
        <h2>Videos</h2>
        <p>Explore top video picks!</p>
      </div>
      {/* End Section Title */}
      <div className="container">
        ...
        >
          ...
          >
            ...
            <li data-filter=".filter-branding">Cybersecurity</li>
            <li data-filter=".filter-product">Cloud Computing</li>
            <li data-filter=".filter-books">Blockchain</li>
            <li data-filter=".filter-books">Internet of Things</li>
          </ul>
